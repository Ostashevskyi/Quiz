...
function createCount(currentQuestion) {
    ...
    count.innerHTML = `${currentQuestion + 1} / ${_getData__WEBPACK_IMPORTED_MODULE_0__.questions.length}`;
...
function appendQuestionInfo(currentQuestion) {
    ...
    categoryTitle.innerHTML = _getData__WEBPACK_IMPORTED_MODULE_0__.questions[currentQuestion].category;
...
function appendQusetionAnswers(currentQuestion) {
    ...
    const incorrectAnswers = _getData__WEBPACK_IMPORTED_MODULE_0__.questions[currentQuestion].incorrect_answers;
    const correctAnswer = _getData__WEBPACK_IMPORTED_MODULE_0__.questions[currentQuestion].correct_answer;
